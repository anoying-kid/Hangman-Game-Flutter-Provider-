...
class LevelSelect extends StatelessWidget {
  ...
  Widget _difficultyLevelWidget(BuildContext context, String text,
      Color textColor, Difficulty difficulty) {
    return SizedBox(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              _difficultyLevelWidget(
                  context, 'Easy', Colors.green, Difficulty.easy),
              const SizedBox(
                height: 10,
              ),
              _difficultyLevelWidget(
                  context, 'Medium', Colors.red, Difficulty.medium),
              const SizedBox(
                height: 10,
              ),
              _difficultyLevelWidget(
                  context, 'Hard', Colors.orange, Difficulty.hard),
            ],
          ),
        ),
      ),
